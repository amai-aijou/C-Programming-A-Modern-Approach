...
// Prototypes
void find_closest_flight(int inputMinutes, int *hDepartTime, int *mDepartTime, int *hArriveTime, int *mArriveTime, char *departAmPm, char *arriveAmPm);
...
int main(void) {
	...
	find_closest_flight(inputMinutes, &hDepartTime, &mDepartTime, &hArriveTime, &mArriveTime, &departAmPm, &arriveAmPm);
