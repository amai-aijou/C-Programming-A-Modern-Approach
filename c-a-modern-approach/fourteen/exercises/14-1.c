...
int main(void) {
	...
	printf("If this fails, it's only because you didn't want it bad enough!\n"
			 "okay, fine, maybe it's because there's a typecasting issue...or you tried using a pointer, like so:\n");
	printf("ex.: %d to the power of three is: %d\n", a, CUBED(a));
	printf("...well, okay, so that worked...maybe my code is just amazing then =P\n");
